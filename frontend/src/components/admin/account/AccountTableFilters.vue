...
const pOpts = computed(() => [{ value: '', label: t('admin.accounts.allPlatforms') }, { value: 'anthropic', label: '智谱 GLM' }, { value: 'openai', label: '通义千问 Qwen' }, { value: 'gemini', label: 'DeepSeek' }, { value: 'antigravity', label: 'MiniMax / 阶跃星辰' }])
