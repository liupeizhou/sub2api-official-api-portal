export default {
  ...
  home: {
    ...
    heroSubtitle: 'One key for Chinese AI model verification',
    heroDescription: 'Access GLM, Qwen, DeepSeek, MiniMax, StepFun and more through one verification portal',
    tags: {
      subscriptionToApi: 'Email Code Login',
      stickySession: 'Chinese Model Routing',
    ...
    features: {
      ...
      multiAccountDesc: 'Smart routing across official API upstreams with automatic failover. Say goodbye to errors.',
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      antigravity: {
        description: 'Configure API access for the MiniMax / StepFun group. Select the configuration method based on your client.',
        claudeCode: 'GLM-compatible Client',
        geminiCli: 'StepFun-compatible Client',
      ...
      gemini: {
        description: 'Add the following environment variables to your terminal profile or run directly in terminal to configure DeepSeek-compatible access.',
        modelComment: 'For example: deepseek-v4-flash or deepseek-v4-pro',
        note: 'These environment variables will be active in the current terminal session. For permanent configuration, add them to ~/.bashrc, ~/.zshrc, or the appropriate configuration file.',
      },
      opencode: {
  ...
  admin: {
    ...
    accounts: {
      ...
      usageWindow: {
        ...
        gemini3Pro: 'Step 2',
        gemini3Flash: 'Step Flash',
        gemini3Image: 'Step Vision',
        claude: 'GLM',
